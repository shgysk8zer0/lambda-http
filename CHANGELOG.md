...
### Fixed
- Add `netlify-cli` to approved scripts
...
### Fixed
- Fix `exports` to use bundled version
...
### Changed
- Use minified bundle by default in node

## [v1.2.3] - 2026-07-14

### Fixed
- Update `allowScripts` with new version of `netlify-cli`
